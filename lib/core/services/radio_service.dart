    ...
    await _player.setAudioSource(
      AudioSource.uri(
        ...
        tag: MediaItem(
          ...
          // No station art asset exists in assets/ yet (assets/icons and
          // assets/images are currently empty — that's a design asset gap,
          // not something this pass can generate). Leaving this null makes
          // the media notification/lock-screen fall back to the app icon,
          // which is a reasonable default rather than a broken image.
          artUri: null,
        ),
      ),
    );
