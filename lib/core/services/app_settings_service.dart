...
/// Persisted app preferences: theme mode, preferred language, and
/// preferred TTS voice engine. Backed by SharedPreferences locally;
/// mirrored to Firestore's `user_settings` collection once signed in
/// (see [SettingsSyncService]) so preferences follow the user across
/// devices per Volume 8's offline-first + cloud-sync strategy.
