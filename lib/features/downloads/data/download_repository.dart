...
/// as a JSON list. A dedicated Isar collection would scale better for a
/// very large download library, but this project has isar in pubspec
/// unused everywhere else too (see result.dart's note on the pre-existing
/// pattern) — matching the existing pragmatic approach rather than being
/// the one feature that introduces Isar wiring on its own.
