...
/// Impact Academy — real Firestore-backed archive. Tapping a message
/// generates (or loads a cached) AI summary via Groq, with a button to
                ...
                : _messages.isEmpty
                    ? const Center(
                        child: Padding(
                          ...
                          child: Text(
                            'No messages yet.\n\nSeed the "messages" Firestore '
                            'collection with category="Impact Academy" documents '
                            '(title, transcript) to see them here.',
